...
import com.example.android.tagsalenow.utils.SunshineDateUtils;
...
public class WeatherProvider extends ContentProvider {
    ...
    private final String TAG = "WeatherProvider";
    /*
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        /* This URI is content://com.example.android.tagsalenow/weather/ */
        matcher.addURI(authority, WeatherContract.PATH_WEATHER, CODE_WEATHER);

        /*
         * This URI would look something like content://com.example.android.tagsalenow/weather/1472214172
    ...
    public int bulkInsert(@NonNull Uri uri, @NonNull ContentValues[] values) {
        ...
        Log.d(TAG, "bulkInsert: !!! values=" + values.toString());
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch (sUriMatcher.match(uri)) {
             ...
             *
             *      content://com.example.android.tagsalenow/weather/1472214172
             *
             ...
             *
             *      content://com.example.android.tagsalenow/weather/
             *
             * sUriMatcher's match method will return the code that indicates to us that we need
